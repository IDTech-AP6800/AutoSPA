...
class QRCodeReceiptActivity : AppCompatActivity(){

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_qr_code_receipt)

        NavigationBar(this)

        //Listener to lead to Receipt Sent
        val continueButton = findViewById<Button>(R.id.qr_receipt_continue)
